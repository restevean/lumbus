...
pub const DEFAULT_COLOR: (f64, f64, f64, f64) = (0.890, 0.482, 0.0, 1.0);

/// Default fill transparency percentage (100 = fully transparent, 0 = fully opaque).
/// 10% means 90% opaque.
pub const DEFAULT_FILL_TRANSPARENCY_PCT: f64 = 10.0;
