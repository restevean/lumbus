...
//!
//! **Migration guide**:
//! 1. Replace `use cocoa::base::{id, nil, YES, NO}` with `use crate::ffi::bridge::*`
//! 2. Replace `use objc::{class, msg_send, sel, sel_impl}` with `use crate::ffi::bridge::*`
//! 3. Replace `use block::ConcreteBlock` with `use crate::ffi::bridge::*`
//!
